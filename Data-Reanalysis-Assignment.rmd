...
```
```{r}
#These are their principle component plots:
...
```
```{r}
#This is there correlation matrix and histogram for the principle components.
...
```
```{r}
#This is the authors' scree plot.
...
```
```{r}
#These are the plot traces for the first chain.
...
```
```{r}
#These are the plots of the following vectors for the chains: mean, standard deviation, proportion, and log-likelihood. 
...
```
```{r}
#These are the plots of the vectors for both probabilityh density functions fo model checking. 
...
```
```{r}
#These are the plots of the correlation matrices for both probabilityh density functions fo model checking. 
...
```
```{r}
#This is the plot of the compositional centers from Ellefsen and Smith:
...
```
```{r}
This is the plot of the translated compositional centers:
...
```
```{r}
#This is the authors' plot of the variation correlation matrices:

...
![In my the centers for rhodium, potassium, and barium are no longer right on top of each other however because the units of concentration have been removed, this plot isn't useful when trying to compare this dataset with others.](https://github.com/geochemica/data-reanalysis-assignment/blob/master/my_chain_1.JPG)

...
```
#add pictures here of their plots
...
```
#ADD IMAGE OF THEIR GRAPHS HERE
...
```
#####This is our matrix of our observed data, which are the 22 principle components. 
```{r}
...
```
#####This is reording the elements so that 
```{r}

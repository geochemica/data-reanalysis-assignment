...
![The plot above is from their paper and user guide to GcClust. Their plot and my plot should look exactly the same. ](https://github.com/geochemica/data-reanalysis-assignment/blob/master/Principle_Component_Plots.jpg)
...
![In my plot the second and fourth chains are switched and would need to be switched back so that the second probability density function is below the first probability density function.](https://github.com/geochemica/data-reanalysis-assignment/blob/master/my_point_stats.JPG)
...
![In my the centers for rhodium, potassium, and barium are no longer right on top of each other however because the units of concentration have been removed, this plot isn't useful when trying to compare this dataset with others.](https://github.com/geochemica/data-reanalysis-assignment/blob/master/translated_comp_centers.jpg)
...
![In my variation matrix it looks like the upper triangle has a higher standard deviation than the lower triangle.](https://github.com/geochemica/data-reanalysis-assignment/blob/master/my_variation_correlation_matrix.JPG)

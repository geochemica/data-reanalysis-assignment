...
#I only included the picture of the first chain instead of all twenty because twenty seemed excessive 
```
...
```
#####Glancing at mine there is mostly blue and red, and from their plot most of the points look either strongly associated with the first probability density function or moderately associated with the second. In this case our plots are very similar. 

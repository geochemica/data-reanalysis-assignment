      ...
      for(i in 1:nChainsPerCore) {
        ...
        rawSamples <- rstan::sampling(sm, data = stanData,
                                      ...
                                      pars=c("theta", "mu1", "mu2",
                                             "tau1", "tau2",
                                             "L_Omega1", "L_Omega2", "log_lik")) #I removed save_dso=FALSE because that gave me an error
...
![This is their image for the first chain. In the standard deviation vector, the second probabiity density function is switched with the first. In their image the two lines never cross each other. If the red and blue lines crossed, they would need to change the posterior probability density function.](https://github.com/geochemica/data-reanalysis-assignment/blob/master/Trace_Chain_1.jpg)
...
#####https://github.com/USGS-R/GcClust 
